...
/***/ (function(module, exports) {
	...
	var MenuController = function () {
		...
		var getStats = function () {
			...
			var url = '../final_twiggle/dev/api/todos/getStats.php';
				...
				if (this.readyState == 4 && this.status == 200) {
					...
					for (var i = 0; i < statsObj.length; i++) {
						var id = statsObj[i].id,
						    created = statsObj[i].created,
						    completed = statsObj[i].completed,
						    deleted = statsObj[i].deleted;

						statContainer.innerHTML = '';

						var build = `<span class="aside__stat__container__title">Total of todos created:</span>
									<span class="aside__stat__container__answer">${created}</span>
									<span class="aside__stat__container__title">Total of todos completed:</span>
									<span class="aside__stat__container__answer">${completed}</span>
									<span class="aside__stat__container__title">Total of todos deleted:</span>
									<span class="aside__stat__container__answer">${deleted}</span>`;
