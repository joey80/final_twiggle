...
$auth0 = new Auth0([
  ...
  'redirect_uri'          => 'https://joeyui-twiggle.herokuapp.com/index.php',
  ...
  <body class="home">
    ...
    <div class="todo-header fixed-top">
        ...
        <div class="container-fluid">
          ...
          <div class="jumbotron">
            <span class="app-title">Twiggle</span><span class="app-subtitle"> - A Todo App for <?php echo $userInfo['name'] ?></span>
